...
#.remove() - Remove o item da lista
#.sort() - Ordenar a lista de acordo com a condição
#.clear() - Remove todos os items da lista
#.count() - Retorna a quantidade de vezes o item aparece na lista
